        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme d-xl-block">
                <div class="app-brand demo my-2">
                    <a href="/admin/pesanan" class="app-brand-link">
                        <span>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p">
                        <div class="d-flex justify-content-between">
                            <h3 style="line-height: 0 !important; margin-top:15px;">Daftar Pesanan</h3>
                            ...
                            <form action="" method="GET" role="search">
                                <div class="container py-2 d-flex flex-column flex-md-row gap-2 align-items-stretch">
                                    <div class="d-flex gap-2 w-100">
                                        ...
                                        <input class="form-control form-control-lg border-0 w-50" type="date" placeholder="Cari Pengguna..." aria-label=".form-control-lg example" value="{{ request('tanggal_awal') }}" name="tanggal_awal">
                                        <input class="form-control form-control-lg border-0 w-50" type="date" placeholder="Cari Pengguna..." aria-label=".form-control-lg example" value="{{ request('tanggal_akhir') }}" name="tanggal_akhir">
                                    </div>
                                    {{-- <div class="d-flex gap-2 w-100"> --}}
                        ...
                        <div class="card">
                            <div class="table-responsive text-nowrap" id="horizontal-example">
                                        ...
                                        @foreach ($pesan as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($item->status == 'disiapkan')
                                                        <a href="/kirim/{{ $item->id }}" class="btn btn-info">Kirim</a>
                                                    @endif
                                                </td>
                                                <td class="text-center">
                                ...
                                <div class="mt-3 px-3">
                                    {{ $pesan->appends(request()->query())->links('pagination::bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                        <!-- Footer -->
