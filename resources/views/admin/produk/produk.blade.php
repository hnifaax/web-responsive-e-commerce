        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme d-xl-block">
                <div class="app-brand demo my-2">
                    <a href="/admin/produk" class="app-brand-link">
                        <span>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p">
                        <div class="d-flex justify-content-between">
                            <h3 style="line-height: 0 !important; margin-top:15px;">Daftar Produk</h3>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        @foreach ($varian as $item)
                                            <tr>
                                                ...
                                                <td class="text-center"><img src="../img/produk/{{ $item->img }}" class="rounded-3 me-3" alt="" style="width: 80%;"></td>
                                                <td> <strong>{{ $item->produk->nama }}</strong></td>
                                                <td class="text-center">Rp. {{ number_format($item->produk->harga, 0, '.', '.') }}</td>
                                                <td>{{ $item->produk->layout }}</td>
                                                <td class="text-center">
                                                    @if ($item->produk->knob == '1')
                                                ...
                                                {{-- <td>{{ $item->produk->knob == '1' ? 'Tersedia' : 'Tidak' }}</td> --}}
                                                {{-- <td>{{ $item->produk->knob }}</td> --}}
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#kandidat-hapus{{ $item->produk_id }}"><i class="bx bx-trash me-1"></i>
                                                                Hapus Data
                                                            </button>
                                                        </div>
                                                    </div>
